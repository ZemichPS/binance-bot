...
//    private final OrderStorageService orderService;
//    private final OrderBrokerService brokerOrderService;
//
//    private final RealTradeProperties tradeProperties;
//
//
//    public BargainServiceImplDeny(BargainDao bargainDao, ConversionService conversionService, OrderStorageService orderService, OrderBrokerService brokerOrderService, RealTradeProperties tradeProperties) {
...
//
//        bargainDto.setStatus(EBargainStatus.CANCELED_BUY_ORDER_WAS_EXPIRED);
//
...
//
//    @Override
//    public BargainEntity complete(BargainDto bargainDto, EBargainStatus status) {
//
...
//        return brokerOrderService.getSymbolPriceTicker(params).orElseThrow().getPrice();
//    }
//
