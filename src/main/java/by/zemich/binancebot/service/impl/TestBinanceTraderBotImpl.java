...
//
//
//    public TestBinanceTraderBotImpl(OrderBrokerService brokerOrderService, INotifier notifier, TestTradingProperties testTradingProperties, IFakeOrderDao fakeOrderDao, IMetricDao metricDao, IBalanceManager balanceManager, IIndicatorReader indicatorReader) {
...
//
//        List<String> symbolsList = brokerOrderService.getSpotSymbolList().orElseThrow();
//
...
//
//                                        BarSeries series = brokerOrderService.getBarSeries(queryDto).orElseThrow(RuntimeException::new);
//
...
//                                                                additionalSeries = brokerOrderService.getBarSeries(queryDto).orElseThrow(RuntimeException::new);
//                                                            }
//
...
//        SymbolPriceTickerDto symbolPriceTicker = brokerOrderService.getSymbolPriceTicker(params).orElseThrow();
//
