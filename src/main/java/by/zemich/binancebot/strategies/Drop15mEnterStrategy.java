...
@Component
public class Drop15mEnterStrategy extends TradeStrategy {

    private final String name = "DROP_15M_ENTER_RULE";
    ...
    protected Rule build(BarSeries series) {
        ...
        return new OverIndicatorRule(openPriceIndicator, bbl)
                .and(new UnderIndicatorRule(closePrice, bbl))
                .and(new OverIndicatorRule(bbw, 4.5))
