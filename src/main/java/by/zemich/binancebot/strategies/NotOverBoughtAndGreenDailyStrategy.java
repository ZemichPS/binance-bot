...
public class NotOverBoughtAndGreenDailyStrategy extends TradeStrategy {
    @Override
    public String getName() {
        return "NOT_OVER_BOUGHT_AND_GREEN_DAILY_ADDITIONAL_STRATEGY";
    }
    ...
    protected Rule build(BarSeries series) {
        ...
        return new UnderIndicatorRule(rsiIndicator, 70)
