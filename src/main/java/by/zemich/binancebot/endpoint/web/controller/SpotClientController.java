...
//    private final MainRule strategyManager;
//
//    private final ITradeManager tradeManager;
//
//    public SpotClientController(IStockMarketService stockMarketService, IOrderService orderService, IAccountService accountService, MainRule strategyManager, ITradeManager tradeManager) {
...
//        OrderDto order = tradeManager.createBuyLimitOrderByAskPrice(symbol);
//
